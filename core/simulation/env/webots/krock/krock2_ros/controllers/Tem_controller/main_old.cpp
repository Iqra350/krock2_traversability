...
RosKrock::RosKrock() :
        gait_files{"./gaits/angles_stop.txt","./gaits/angles_normal.txt","./gaits/angles_high1.txt","./gaits/angles_low.txt"},
        current_gait_idx(0),
        controller_mode(0),
        freq(FREQUENCY),
        freq_left(0),
        ...
        freq_offset(0.8)
{
    ...
    log_mode = true;
    gpsLog1.open("./logData/gpsLog1.txt");
...
void RosKrock::launchRos(int argc, char **argv){
    ...
    // double compassData[3], IMUdata[3], ts_data[12+12], markers[4];
...
// //=============================  LOOP  =============================================
  ...
  // controller.setTimeStep(dt);
    ...
    // robotSim()->getPositionTorques(feedbackAngle, feedbackTorques);
    ...
    // controller()->updateRobotState(feedbackAngle, feedbackTorques);
...
int RosKrock::step(int duration){
    ...
    robotSim()->setAngles(angref,USED_MOTORS);
